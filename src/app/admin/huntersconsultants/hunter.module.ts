...
import { FieldPipe4 } from '../../field4.pipe';
import { ConfirmDialogModule} from 'primeng/confirmdialog';
import { HotListhuntersComponent } from '../huntersconsultants/hotlist/user-list/user-list.component';
@NgModule({
  declarations: [UserIndexComponent,HotListhuntersComponent, UserListComponent,UserCreateComponent,UserEditComponent,FieldPipe4],
  imports: [
    CommonModule,
    UserRoutingModule,
