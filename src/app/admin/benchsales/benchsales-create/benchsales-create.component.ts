...
@Component({
  selector: 'benchsales-user-create',
  templateUrl: './benchsales-create.component.html',
  providers: [MessageService],
  styleUrls: ['./benchsales-create.component.scss']
})
export class BenchsalesCreateComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private messageService: MessageService, private userRest: BenchsalesRestService, private router: Router) { }
