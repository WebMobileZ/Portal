...
import { InterviewRestService } from '../interview-rest.service';
...
export class UserListComponent implements OnInit {
  ...
  constructor(private confirmation: ConfirmationService, private fb: FormBuilder, private messageService: MessageService, private route: ActivatedRoute, private restService: InterviewRestService,
    private router: Router) { }

  ngOnInit() {

    this.restService.getConsultants().subscribe(
  ...
  private _dropDatabase(index) {
    ...
    this.restService.statusChangeConsultant(formData).subscribe(
      (response) => {
