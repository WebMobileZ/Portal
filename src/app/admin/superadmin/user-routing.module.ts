 ...
 // { path: 'list', component: UserListComponent, outlet: 'users' },
  {
    ...
    children: [
      ...
      {path: 'sumissioncreate', component: BenchCreateComponent,data: {
        expectedRole: 'Admin'
      }},
      {path: 'sumissionlist', component: BenchListComponent,data: {
        expectedRole: 'Admin'
      }},
      {path: 'interviews', component: InterviewComponent,data: {
        expectedRole: 'Admin'
      }},
      {path: 'hotlist', component: HotListComponent,data: {
        expectedRole: 'Admin'
      }},
